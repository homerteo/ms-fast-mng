...
import { onFastMngSharkAttackModified } from "../gql/SharkAttack";
...
function SharkAttacksTable(props) {
    ...
    const onFastMngSharkAttackModifiedData = useSubscription(...onFastMngSharkAttackModified({ id: "ANY" }));
    ...
    }, [dispatch, filters, order, page, rowsPerPage, onFastMngSharkAttackModifiedData.data]);
